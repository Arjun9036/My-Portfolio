                ...
                <div className="row d-flex justify-content-center">
                    <div className="card p-3 m-3 mb-5" style={{backgroundColor:'var(--color-2)',border:'none',width:'18rem'}}>
                        ...
                        <div className="col-md-10 m-auto">
                            <img alt="Static Badge" className='m-1' src="https://img.shields.io/badge/HTML5-E34F26.svg?style=for-the-badge&logo=html&logoColor=white"/>
                            <img alt="Static Badge" className='m-1' src="https://img.shields.io/badge/CSS3-1572B6.svg?style=for-the-badge&logo=css&logoColor=white"/>
                    ...
                    <div className="card p-3 m-3 mb-5" style={{backgroundColor:'var(--color-2)',border:'none',width:'18rem'}}>
                        ...
                        <div className="col-md-10 m-auto">
                            ...
                            <img alt="Static Badge" className='m-1' src="https://img.shields.io/badge/SQL-00002C.svg?style=for-the-badge&logo=rust&logoColor=white"/>
                        </div>
                    </div>
                    <div className="card p-3 m-3 mb-5" style={{backgroundColor:'var(--color-2)',border:'none',width:'18rem'}}>
